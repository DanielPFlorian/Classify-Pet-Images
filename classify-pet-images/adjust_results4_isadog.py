...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            # Check if dogname(line) doesn't already exist as key in dognames_dic, otherwise print 
            # an error message because indicates duplicate dog names in dognames.txt
            if line not in dognames_dic:

            # Adds dogname(line) to dogsnames_dic
                dognames_dic[line] = 1

            else:
                print("** Warning: Key=", line, 
                "already exists in dognames_dic. Check for duplicate dog names\
                in dognames.txt")
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dic:
            ...
            # extends (1, 1) because both labels are dogs
